            ...
            <div class="col-sm">
                ...
                <form action="process_add_author.php" method="post">
                    <div class="input-group mt-3 mb-3">
                        <span class="input-group-text" id="">Tên tác giả</span>
                        <input type="text" class="form-control" name="tieude"  id="tieude">
                    </div>


                    <div class="input-group mt-3 mb-3">
                        <span class="input-group-text" id="">Hình tác giả</span>
                        <input type="text" class="form-control" name="hinhanh"  id="tieude">
                    </div>

                    <div class="form-group  float-end ">
                        <input type="submit" value="Thêm" name ="them" class="btn btn-success">
