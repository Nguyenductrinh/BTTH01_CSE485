                    ...
                    ?>
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <a href="process_remove_author.php?id=<?php echo $row["ma_tgia"] ?>" onclick="return confirm('Bạn có chắc muốn xóa tác giả này không?')"><i class="fa-solid fa-trash"></i></a>
                                    </td>
                                </tr>
                            </tbody>
